    ...
    <main>
      <section id="home" className="hero"><div className="container hero-grid">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><button className="primary" onClick={()=>nav('work')}>Explore my work <ArrowRight size={18}/></button><a className="secondary" href="/work-samples/Goodness_Nwafor_CSM_Resume_Final.pdf" target="_blank">View résumé <ExternalLink size={16}/></a></div>
